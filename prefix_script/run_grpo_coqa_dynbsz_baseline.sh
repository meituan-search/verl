#!/usr/bin/env bash
# GRPO CoQA — dynbsz baseline (no prefix tree), tp=1
...
OUTDIR="/tmp/verl_submit/profiles/dynbsz_baseline/${TS}"
mkdir -p "$OUTDIR"

export TENSORBOARD_DIR="${TENSORBOARD_DIR:-$HOME/profiles/dynbsz_baseline_${TS}/tb}"
mkdir -p "$TENSORBOARD_DIR"

echo "================================================================"
echo "dynbsz-baseline run  TS=$TS"
echo "  output: $OUTDIR"
echo "================================================================"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name="dynbsz_baseline_${TS}" \
    trainer.save_freq=-1 \
    trainer.test_freq=-1 \
