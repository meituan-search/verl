#!/usr/bin/env bash
# GRPO LongReason — MAGI + torch profiler for 1 layer
# Profiles actor update_actor at specific steps using PyTorch profiler
# Usage: bash prefix_script/run_grpo_longreason_magi_torch_profile.sh [8k|16k|32k|64k|128k]
...
PROFILE_DIR="${HOME}/torch_profile/magi_${SPLIT}_${TS}"
OUTDIR="${OUTDIR:-/tmp/claude/grpo_longreason/magi_torch_profile_${SPLIT}_${TS}}"
...
echo "================================================================"
echo "GRPO LongReason — MAGI + torch profiler  SPLIT=$SPLIT  TS=$TS"
...
BASE_ARGS=(
    ...
    trainer.project_name="grpo_longreason_1.7b_magi_torch_profile"
    trainer.experiment_name="longreason_${SPLIT}_magi_torch_profile_${TS}"
    trainer.save_freq=-1
    trainer.test_freq=-1
