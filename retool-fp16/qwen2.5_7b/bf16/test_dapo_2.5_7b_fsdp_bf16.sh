...
project_name='DAPO-retool-qwen2.5-7b-instruct-bf16'
exp_name='bf16'
...
DATA_ROOT=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-friday-studio/FTI/houzhenggang/wangshulin02/data
...
CKPTS_DIR=/cfs_shtx5_serving_3/mlp/training/docker/user/hadoop-ai-search/wangshulin02/model/checkpoint/$exp_name
train_files="['$dapo_math_17k']"
test_files="['$aime_2024']"

# tool
tool_config_path=retool-fp16/qwen2.5_7b/bf16/sandbox_fusion_tool_config.yaml
max_turns=16
...
infer_ppo_max_token_len=$(( actor_ppo_max_token_len * 4 ))
offload=True
gen_tp=1
train_tp=2
train_pp=1
