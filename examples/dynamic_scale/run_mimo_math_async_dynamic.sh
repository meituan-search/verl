...
TRAIN_FILE="/cfs_shtx5_serving_3/mlp/training/docker/user/hadoop-ai-search/zhangshuai122/data/dapo/dapo-math-17k.parquet"
TEST_FILE="/cfs_shtx5_serving_3/mlp/training/docker/user/hadoop-ai-search/zhangshuai122/data/dapo/aime-2024.parquet"

MODEL_PATH=/cfs_shtx5_serving_3/mlp/training/docker/user/hadoop-ai-search/zhangshuai122/models/XiaomiMiMo/MiMo-7B-RL
...
python3 -X faulthandler -m verl.experimental.fully_async_policy.fully_async_main \
   ...
   +actor_rollout_ref.actor.megatron.override_transformer_config.recompute_num_layers=1 \
    ...
    async_training.dynamic_scaling_deactivate_ratio=0.4 \
